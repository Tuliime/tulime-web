...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  const newPasswordRaw = form.get("currentpassword");
...
const ChangePassword = () => {
  ...
  const showCurrentPassordHandler = () => {
          ...
          <div className="flex flex-col gap-1 relative">
            ...
            {showCurrentPassword ? (
              <svg
                ...
                onClick={showCurrentPassordHandler}
              >
            ...
            <div>
              ...
              newPassword === currentPassword ? (
                <span className="absolute right-4 text-green-100 top-8 cursor-pointer">
                  <IoMdCheckmark />
                </span>
              ) : newPassword.length > 0 &&
                newPassword.length === currentPassword.length ? (
                <span className="absolute right-4 text-red-800 top-8 cursor-pointer">
                  <FaXmark />
                </span>
              ) : null}
            </div>
